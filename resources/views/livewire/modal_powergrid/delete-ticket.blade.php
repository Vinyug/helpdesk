<form method="post" action="{{ route('tickets.destroy', $ticket->uuid) }}" class="p-6">
    ...
    <h2 class="text-lg font-medium">Êtes-vous sûr de vouloir supprimer ce ticket ?</h2>

    <p class="mt-1 text-sm text-custom-grey">Une fois ce ticket supprimé, toutes ses ressources et données seront définitivement effacées.</p>
