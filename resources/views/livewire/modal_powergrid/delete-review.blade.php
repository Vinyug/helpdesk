<form method="post" action="{{ route('reviews.destroy', $review->id) }}" class="p-6">
    ...
    <h2 class="text-lg font-medium">Êtes-vous sûr de vouloir supprimer cet avis ?</h2>

    <p class="mt-1 text-sm text-custom-grey">Une fois cet avis supprimé, toutes ses ressources et données seront définitivement effacées.</p>
