<form method="post" action="{{ route('companies.destroy', $company->uuid) }}" class="p-6">
    ...
    @if ($company->users()->exists())
        <p class="mt-4 text-sm font-medium text-red-600">Vous ne pouvez pas supprimer l'entreprise. Tous les employés doivent être réattribués à une nouvelle entreprise.</p>
    @endif
