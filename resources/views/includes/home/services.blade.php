<div class="relative mt-24 md:mt-36">
    ...
    <div class="flex flex-col mt-16 md:mt-20">
        ...
        @foreach ($services as $service => $description)
            @if ($counter % 2 == 0)
                {{-- card left --}}
                <div class="w-full flex flex-col md:self-start items-start mb-8 md:mb-12 bg-white border border-gray-200 rounded-sm shadow md:flex-row md:max-w-xl xl:max-w-3xl md:min-h-[256px] md:ml-[7%] lg:ml-[15%] 2xl:ml-[18%]">
                    <img class="md:order-1 self-center w-16 mt-8 md:mt-0 md:ml-10 md:mr-4" src="assets/images/img-service.png" alt="image service">
